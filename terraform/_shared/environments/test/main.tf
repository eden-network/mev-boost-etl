...
module "service_account" {
  ...
  description      = "Service account with cloud run permissions and read/write access to mev_boost dataset in the private project, read/write access to mev_boost dataset in public project"
