...
from reader_big_query import async_get_pod_config
...
async def async_execute():        
    ...
    tasks = [async_process_relay(row['relay'], row['base_url'], row['rate_limit'], pod_config['start_slot'], pod_config['end_slot']) for row in relay_metadata]
