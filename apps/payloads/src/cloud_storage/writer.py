...
async def async_push_to_gcs(client: Client, gzip_file_bytes: bytes, object_name: str):
...
def push_to_gcs(client: Client, gzip_file_bytes: bytes, object_name: str) -> bool:
