...
class TestTryDownloadZip(unittest.TestCase):    
    ...
    def test_transform_and_check_csv_on_disk(self):
        ...
        with open(f"./data/builder_block_received/{relay}-{slot}.json", "rb") as file_stream:
            ...
            with open(f"./data/builder_block_received/{relay}_{slot}_T.json", 'w') as output_file:
    ...
    def test_transform_and_gzip_json_file(self):
        ...
        with open(f"./data/builder_block_received/{relay}-{slot}.json", "rb") as file_stream:
            ...
            with open(f"./data/builder_block_received/{relay}_{slot}_T.gz", 'wb') as output_file:
